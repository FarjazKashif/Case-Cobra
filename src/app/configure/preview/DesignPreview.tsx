...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
    ...
    const tw = COLORS.find((supportedColor) => supportedColor.value == color)?.code
    ...
    return (
        <>
            ...
            <div className='mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12'>
                <div className='md:col-span-4 lg:col-span-4 md:row-span-2 md:row-end-2'>
                    {/* <Phone
                        className={cn(`bg-${tw}`, "max-w-[150px] md:max-w-full")}
                        imgSrc={configuration.croppedImageUrl!}
                    /> */}
                    <div className='relative w-[30rem] md:max-w-full bg-opacity-50 pointer-events-none aspect-[7234/7638]'>
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                            width="100%" viewBox="0 0 7324 7638" enable-background="new 0 0 7324 7638" className="absolute inset-0">
                            <path fill={tw} opacity="1.000000" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.000000"
                                d="
...
"/>
                            <path fill={tw} opacity="1.000000" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="4.000000"
                                d="
...
"/>
                        ...
                        <AspectRatio ratio={7234 / 7638} className='pointer-events-none relative z-50 aspect-[7234/7638] w-full'>
                        ...
                        <NextImage src={configuration.croppedImageUrl!} alt="Image" className="pointer-events-none z-50 select-none h-full" fill />
                    </AspectRatio>
                    </div>
                </div>
